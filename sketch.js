...
function preload(){
  trex_running =   loadAnimation("Running/edits/1.png","Running/edits/2.png","Running/edits/3.png");
...
function setup() {
  ...
  background0 = createSprite(150, 100);
  background0.addImage(backgroundimg)
  background0.x = 150;
  background0.velocityX=-1;
